...
\begin{center}
	...
	\hfill \break
	\large{Метод автоматизированного поиска и вывода изоморфных контекстно-зависимых визуальных отображений на изображении}\\
	\hfill \break
	\hfill \break
	\hfill \break
	\hfill \break
	...
	\normalsize {
		...
		\makebox[\textwidth][c]{}%
		\makebox[0pt][r]{{$\underset{\text{(Подипсь, дата)}}{\underline{\hspace{8cm}}}$ \space Хмельщиков А.Ю.}}
	}\\
	\hfill \break	
	\normalsize {
		\noindent
